  ...
  return (function e(t, n, r) {
        ...
        var DOMPropertyInjection = {
          ...
          injectDOMPropertyConfig: function(domPropertyConfig) {
            ...
            for (var propName in Properties) {
              ...
              ("production" !== "development" ? invariant(!DOMProperty.mustUseAttribute[propName] || !DOMProperty.mustUseProperty[propName],
              ...
              ("production" !== "development" ? invariant( !! DOMProperty.hasBooleanValue[propName] + !! DOMProperty.hasNumericValue[propName] + !! DOMProperty.hasOverloadedBooleanValue[propName] <= 1,
    ...
    42: [
      function(_dereq_, module, exports) {
        ...
        //  console.log(id, registrationName, listener+"", transaction)
          if (container) {
          ...
          _createOpenTagMarkupAndPutListeners: function(transaction) {
            ...
            for (var propKey in props) {
              ...
              if (registrationNameModules.hasOwnProperty(propKey)) {
               // console.log(this._rootNodeID, propKey, propValue)
    ...
    70: [
      function(_dereq_, module, exports) {
        ...
        function mountComponentIntoNode(
          ...
          transaction,
          shouldReuseMarkup) {
         // console.log(ReactReconciler.mountComponent+"")
          var markup = ReactReconciler.mountComponent(
